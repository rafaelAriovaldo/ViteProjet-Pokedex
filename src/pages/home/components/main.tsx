            ...
            <div className=' bg-white w-[897px] h-[522px] border rounded-2xl justify-center ml-[1rem] mt-[2rem]  flex'>
                <nav className=" mr-[0rem] p-14 font-Im-feel text-2xl">
                    <div className="flex gap-40">
                        <h1 className=""><Link to={'/pokemom/register'} className="font-Im fell Englesh">Cadastre</Link></h1>
                        <h1 className=""><a href="">Crie seu time</a></h1>
                        <h1 className=""><a href="/abc">Pesquise</a></h1>
                    </div>
